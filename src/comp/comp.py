...
print("Starts with D:")
a = [human.name for human in humans if human.name.lower().startswith('d')]
print(a)
...
c = [human.name for human in humans if any(human.name.lower().startswith(letter) for letter in 'cdefg')]
print(c)
